# Estructuras de Datos en Python: Más allá de lo básico
...
> **Pro-Tip**: Si necesitas una cola (FIFO), **NO** uses `list.pop(0)` ya que es O(n). Usa `collections.deque`.
...
## 3. Módulo `collections`: Las herramientas ocultas
